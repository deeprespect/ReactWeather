...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherResult = __webpack_require__(220);
	var openWeatherAPI = __webpack_require__(221);
	...
	var Weather = React.createClass({
	  ...
	  searchHandler: function searchHandler(location) {
	    var temp;
	    var _root = this;
	  ...
	  render: function render() {
	    ...
	    function renderMessage() {
	      if (isLoading) return React.createElement(
	        ...
	        null,
	        'Fetching data....'
	      );else if (temp && location) return React.createElement(WeatherResult, { location: location, temp: temp });
	    }
	    ...
	    return React.createElement(
	      ...
	      React.createElement(WeatherForm, { onSearch: this.searchHandler }),
	      renderMessage()
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = "http://api.openweathermap.org/data/2.5/weather?appid=d31460c25a21d2034f509907d5b4e575&units=imperial&q=";

	module.exports = {
	  getTemp: function getTemp(location) {
	    return axios.get(OPEN_WEATHER_MAP_URL + location).then(function (response) {
